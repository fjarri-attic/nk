set VM="c:\vm\Win2k3\Windows Server 2003 Enterprise Edition.vmx"
...
vmrun -gu Administrator -gp 1q2w3e runProgramInGuest %VM% "c:\windows\system32\cmd.exe" "/c mkdir \"%DEPDIR%\""
